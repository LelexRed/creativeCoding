  ...
  setup() {
    ...
    for (let j = 0; j < this.totalLines; j++) {
      for (let i = 0; i < this.subdivisions; i++) {
        ...
        // y += random * -variance; --> met trop de noise middle
  ...
  draw() {
    ...
    for (let i = 0; i < this.totalLines; i++) {
      ...
      for (let j = 0; j < this.subdivisions - 1; j++) {
        ...
        // replace that line with a quadratic curve ( peut rendre le truck glitchy)
    ...
    //requestAnimationFrame(this.draw.bind(this)); --> fond
  }
}
